...
const CONFIG = {
    ...
    questions: {
        first: {
            ...
            yesBtn: "Dap",                                             // Text for "Yes" button
        ...
        second: {
            ...
            startText: "Atatica!",                                   // Text before the percentage
            nextBtn: "Next ❤️"                                         // Text for the next button
        },
        third: {
            text: "Vrei sa fii my Valentina mea?🌹", // The big question!
            yesBtn: "Dap!",                                             // Text for "Yes" button
            noBtn: "NUUUU"                                                 // Text for "No" button
        }
    },
    ...
    loveMessages: {
        extreme: "WOOOOW CHIAR MA IUBESTI ATAT?? 🥰🚀💝",  // Shows when they go past 5000%
        high: "De la pamant pan la luna! 🚀💝",              // Shows when they go past 1000%
        normal: "Pana n fundu curtii! 🥰"                           // Shows when they go past 100%
    },

    // Messages that appear after they say "Yes!"
    celebration: {
        title: "Yay! Sunt cel mai fericit baiat! 🎉💝💖💝💓",
        message: "Acu hai sa ti primesti cadoul, e secret, upsii!",
